...
public class RosterMod {
    ...
    public boolean equals(Object o) {
        ...
        return set == rosterMod.set && level == rosterMod.level && pips == rosterMod.pips && tier == rosterMod.tier && Objects.equals(id, rosterMod.id) && Arrays.equals(stat, rosterMod.stat);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(id, set, level, pips, tier);
        result = 31 * result + Arrays.hashCode(stat);
        return result;
    }
}
